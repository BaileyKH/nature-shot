...
export const Photographers = () => {
    ...
    return(
        <section className="min-h-screen flex flex-col justify-center">
            <img src={bg} width="1261px" height="841px" alt="beautiful snow covered mountain during sunrise" className="relative object-cover object-center h-screen brightness-50"/>
